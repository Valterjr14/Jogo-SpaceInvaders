...
public class InvasoresEspaciais extends JPanel implements ActionListener, KeyListener {
    ...
    public class Tiro extends ObjetoDoJogo {
        ...
        // Sobrecarga com diferente altura e largura
        public Tiro (int posX, int posY, int largura, int altura) {
        	this(posX, posY, largura, altura, 5); //Define um deslocamento padrão
        }
